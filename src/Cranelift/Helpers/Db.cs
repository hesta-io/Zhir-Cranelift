...
VALUES('{transaction.UserId}', '{transaction.TypeId}', '{transaction.PaymentMediumId}', '{transaction.PageCount}', '{transaction.Amount}', @userNote, @adminNote, @transactionId, @createdAt, '{transaction.CreatedBy}');
";
